...
This function plots out the data returned by load_footfall(), and fit_footfall(). The function creates three different plots, The first plot is a point plot of the 'load_footfall()' data with respect to location and Counts, it also creates a box plot of this data. Then the third plot is a linear regression plot of the fit_footfall() model, plotting the residual against fitted values.
In the example below, a plot is generated from the data of load_footfall() and fit_footfall().
